...
namespace TimesheetScheduler.Controllers
{
    public class NewController : Controller
    {
...

        {
            ...
            Excel.Worksheet wrkSheet = xlBook.Worksheets[2];
        ...
        private static void buttonMacro(string buttonName, Microsoft.Office.Interop.Excel.Application xlApp, Microsoft.Office.Interop.Excel.Workbook wrkBook, Microsoft.Office.Interop.Excel.Worksheet wrkSheet)
...

        {
            ...
            TfsTeamProjectCollection tpc = new TfsTeamProjectCollection(new Uri("http://vssdmlivetfs:8080/tfs/BOMiLiveTFS/"),tfsCred);
...

        {
            ...
            //var projectUri = collection.GetProjectUri(collection, "project_name");
...
//table.Rows.Add(1, "Amar", "M", 78, 59, 72, 95);

//table.Rows.Add(2, "Mohit", "M", 76, 65, 85, 87);

//table.Rows.Add(3, "Garima", "F", 77, 73, 83, 64);

//table.Rows.Add(4, "jyoti", "F", 55, 77, 85, 69);

//table.Rows.Add(5, "Avinash", "M", 87, 73, 69, 75);

//table.Rows.Add(6, "Devesh", "M", 92, 87, 78, 73);
...
//    table.Rows.Add(i, day, (345450 + i),

//        ("Description "+ i), 7.5, 0, ("Comments"+ i), IsWeekend(day));
